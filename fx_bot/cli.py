...
from fx_bot import data as data_mod
from fx_bot import config, metrics, costs, risk
from fx_bot.engine import backtest
from fx_bot.compare import compare, REGISTRY
...
def _add_source_args(p):
    p.add_argument("--asset", default="forex", choices=["forex"],
...
def main() -> None:
    ...
    if args.cmd == "compare":
        ...
        from fx_bot.report import generate
        path = generate(_load(args), args.out, periods_per_year=ppy)
        print(f"report written -> {path}")
    elif args.cmd == "validate":
        from fx_bot.validate import holdout_validate
        ...
        from fx_bot.pairs import oos_pairs
        ...
        from fx_bot.native_app import main as run_app
        run_app()
    elif args.cmd == "funding":
        from fx_bot.funding import run_funding
        ...
        from fx_bot.ml import nn_search
        ...
        from fx_bot.ml import run_ml, holdout_ml
